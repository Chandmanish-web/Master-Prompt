    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-100 via-white to-slate-100 text-slate-900">
      ...
      <main className="mx-auto max-w-7xl px-6 py-16 lg:py-24">
        <div className="grid gap-16 lg:grid-cols-[0.9fr_0.85fr] lg:items-center">
          <motion.section initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="space-y-8">
          ...
          <div id="features" className="grid gap-4 sm:grid-cols-2">
            {features.map((feature, index) => {
              ...
              return (
                <motion.div key={feature.title} initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.45, delay: index * 0.08 }}>
        ...
        <section id="about" className="mt-24 grid gap-10 lg:grid-cols-[0.9fr_0.9fr]">
